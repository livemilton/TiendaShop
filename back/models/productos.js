...
const productosSchema=mongoose.Schema({
    nombre:{
        ...
        trim: true, //elimina valores en blanco al inicio y al final del texto para evitar errores en buscar el PT
    ...
    inventario:{
        ...
        maxLength:[5, "Cantidad maxima del producto no puede pasar 99999"],
        default:0
    },
    numCalificaciones:{
        type:Number,
